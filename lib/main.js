...
import { PACKAGE, Debug, cursorChangeThrottle as defaultCursorChangeThrottle, LINT_THROTTLE } from './config'
...
export const activate = () => {
  ...
  let cursorChangeThrottle = defaultCursorChangeThrottle
  ...
  const onChangeGrammar = () => {
    const {
      unsupportedScope,
      cursorChangeThrottle: newCursorChangeThrottle = defaultCursorChangeThrottle,
    } = getRefsContext()

    cursorChangeThrottle = newCursorChangeThrottle
